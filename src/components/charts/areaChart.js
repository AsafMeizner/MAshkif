...
import {
    AreaChart, Area, XAxis, YAxis, CartesianGrid, Tooltip, Legend, ResponsiveContainer, Label, Text,
    ReferenceLine, ReferenceDot
} from 'recharts';

const CustomAreaShape = (props) => {
    const {
        fill,
        stroke,
        strokeWidth,
                        ...
                        visibleTypes.includes(type.key) && (
                            <Area
                                ...
                                label={({ value, x, y }) => (
                                    <Text
                                        x={x}
                                        y={y - 10} // Position the label above the data point
...
export default AreaGraphExample;
